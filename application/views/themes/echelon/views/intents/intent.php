...
<section class="content">
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            <?php echo form_open_multipart($this->uri->uri_string(),array('id'=>'intent-form','class'=>'_intent-form')); ?>
            <div class="form-group">
                <?php
                if (isset($intent) && $intent->status){
                    $checked = 'checked';
                }
                ?>
                <input type="checkbox"  value="1" name="status" class="checkbox"   <?php echo $checked?>>
...
<script>
    ...
    $(function(){
        ...
        $('#promptModal').on('show.bs.modal', function(e) {
            ...
            $.ajax({
                type: 'GET',
                url: site_url + 'intents/get_prompts/'+entity,
                dataType: 'json',
        ...
        $('.btn-add-prompt').on('click',function(){
            ...
            $.ajax({
                type: 'POST',
                url: site_url + 'intents/update_prompts',
                data : data,
                dataType: 'json',
                success: function (json) {
    ...
    function removePrompt(id){
        $.ajax({
            type: 'GET',
            url: site_url + 'intents/delete_prompt/'+id,
            dataType: 'json',
            success: function (json) {
            }
        });
