                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <select name="contexts" class="form-control select2" multiple="multiple" data-placeholder="Select context"
                                            style="width: 100%;">
                                        <option>order.drink-followup</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-hover table-condensed tblusersays">
                            ...
                            <tbody id="usersays-<?php echo $rowvalues?>">
                                <tr class="clickable" data-toggle="collapse" data-target="#group-of-rows-<?php echo $rowvalues?>" aria-expanded="false" aria-controls="group-of-rows-<?php echo $rowvalues?>">
                                    <td onclick="details('0')"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $intentusersay['usersay']?>
                            ...
                            <?php if (getUsersayParameters($intentusersay['id'])) { ?>
                            ...
                            <?php foreach (getUsersayParameters($intentusersay['id']) as $intentsusersaysparameter) { ?>
                                <tr>
                                    <td><?php echo $intentsusersaysparameter['parameter_name']?><input value="<?php echo $intentsusersaysparameter['parameter_name']?>" name="parameters[<?php echo $rowvalues?>][<?php echo $rows?>][parameter_name]" type="hidden"></td>
                                    <td><?php echo $intentsusersaysparameter['entity']?><input value="<?php echo $intentsusersaysparameter['entity']?>" name="parameters[<?php echo $rowvalues?>][<?php echo $rows?>][entity]" type="hidden"></td>
                                    <td><?php echo $intentsusersaysparameter['resolved_value']?><input value=" <?php echo $intentsusersaysparameter['resolved_value']?> " name="parameters[<?php echo $rowvalues?>][<?php echo $rows?>][resolved_value]" type="hidden"></td>
                                </tr>
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="text" name="events" class="form-control" value="" placeholder="Intent events">
                                </div>
                            </div>
                        </div>
                        <!-- /.row -->
